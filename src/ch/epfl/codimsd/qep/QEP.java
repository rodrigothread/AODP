 ...
 * Version 1
 *
 * The QEP defines a common structure for CoDIMS when we store operators we read
 * from a query exeuction plan (xml qep, strin qep, etc.).
 *
...
public class QEP {
    ...
    /**
     * Flag used to determine if the query execution plan is to be executed
     * remotly.
     */
