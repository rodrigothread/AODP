...
/**
 * Abstract class that defines commons functions and structrues for all CoDIMS
 * operators. In this version, it was opted to eliminate the AlgebraicOperator
 * and ControlOperator in order to prevent a long chain of operators causing
 * long execution time. For same reason, the method hasNext was removed. Here
 * are the functionalities of the class :
 ...
 *
 * Added by Othman : - Javadoc translated to english. - Constructor changed,
 * from Operator(int id, BlackBoard blackBoard) to Operator(int id) - Added
 * method returnMetadata().
 *
...
public abstract class Operator {
    ...
    /**
     * Description of the format of the tuples that this operator produces, one
     * for each consumer.
     */
    ...
    public static Logger logger = Logger.getLogger(Operator.class.getName());
    ...
    /**
     * Abstract class for setting the metadata. Each operator should know how to
     * define its own metadatas.
     *
