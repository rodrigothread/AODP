 ...
 * Uma tupla � definida a partir de um um conjunto de colunas que ocupam posi��o
 * fixa.<p>
 *
 * Tuple of the relationary model defines the one format. One tuple is defined
 * from one set of columns that occupy a fix position.
 *
...
public class TupleMetadata implements Metadata, Serializable {
    ...
    /**
     * Obtem o dado que descrve a coluna que possui este nome. It gets the data
     * that describe the column that possesss this name.
     *
    ...
    /**
     * Obtem o dado que descrve a coluna que ocula a n-�sima posi��o. It gets
     * the data that describe the column that ocuppies the n-th position.
     *
    ...
    /**
     * Obtem o conjunto de colunas que descrevem uma tupla. It gets the set of
     * columns that describe one tupla.
     *
    ...
    /**
     * Substitui a descri��o das colunas de uma tupla por este conjunto de
     * colunas. Tuple for this set of columns substitutes the description of the
     * columns.
     *
    ...
    /**
     * Substitui a descri��o da coluna que ocupa a n-�sima posi��o. It
     * substitutes the description of the column that occupies the n-th
     * position.
     *
    ...
    /**
     * Retorna a posi��o da coluna com nome name. It returns the position from
...
//    }
    /**
     * Retorna o tamanho em bytes das tuplas descritas por este metadado. It
     * returns the size in bytes from tuples described for this metadado.
     *
