...
/**
 * Descreve as informa��es necess�rias a representa��o de uma coluna no modelo
 * relacional.
 *
...
public class Column extends Data {
     ...
     * @param position Deslocamento em nr de bytes com rela��o ao in�cio da
     * tupla.
     * @param key Define se esta coluna � uma das colunas que pertencem a chave
     * prim�ria.
     */
...
//	}
    ...
    /**
     * Remove as refer�ncias realizadas por este objeto afim de se melhorar o
