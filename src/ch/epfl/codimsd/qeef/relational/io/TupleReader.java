 ...
 *
 * Toda opera��o de leitura de tupla ou bloco deve ser precedida por uma chamada
 * a eof().
 *
...
public class TupleReader implements ch.epfl.codimsd.qeef.io.InstanceReader {
    ...
    /**
     * Caracter de controle utilizado para identificar se existem mais tuplas a
     * serem lidas ou se a pr�xima tupla � nula. Valores poss�veis:
     * <p>
     * <ul>
     * <li>'0' eof
     ...
     *
     * @return True se existir mais tuplas/blocos a serem lidos, false caso
     * contr�rio.
     */
     ...
     * fluxo.
     * @throws EOFException Se o final do fluxo for atingido antes que a tupla
     * seja lida.
     */
     ...
     * @throws IOException Se acontecer algum problema durante a leitura do
     * fluxo.
     * @throws EOFException Se o final do fluxo for atingido antes que todas as
     * tuplas do bloco sejam deserializadas.
     */
