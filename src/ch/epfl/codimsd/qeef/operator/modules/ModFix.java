...
/**
 * Representa o tipo de liga��o mais simples entre operadores. Neste tipo de
 * m�dulo nenhum operador de controle � adicionado entre um consumidor e
 * produtor.
 *
 * It represents the type of simpler linking between operators. In this type of
 * module no operator of control is added between a consumer and producer.
 *
...
public class ModFix extends Modulo {
     ...
     * Construtor padr�o.
     *
     * @param root Primeiro operador do fragmento de plano encapsulado por este
     * m�dulo.
