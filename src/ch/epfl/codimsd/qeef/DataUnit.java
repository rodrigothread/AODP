...
/**
 * Classe abstrata que generaliza uma unidade de dados no framework
 * ch.epfl.codimsd.qeef. Abstract classroom that generalizes a unit of data in
 * framework ch.epfl.codimsd.qeef.
 *
...
public abstract class DataUnit implements Cloneable, Serializable {
    ...
    /**
     * Tabela de propriedade utilizadas para guardar informa��es durante o
     * processamento desta tupla. Table of property used to keep the information
     * during the processing of this tuple.
     */
     ...
     * refer�ncias.
     *
     * The implementation of this default method of the language if became
     * obrigt�rio with the objective to speed up the process of memory release
     * that is carried through in the Garbage Collector. One sends regards to
     * attribute null to all its references.
     */
    public abstract void finalize();

    /**
     * Cria uma outra instancia deste objeto id�ntica a esta. It creates another
     * instance of this identical object to this.
     *
    ...
    /**
     * Grava o conte�do desta unidade de dados de maneira formatada no fluxo
     * out. Out records the content of this unit of data in way formatted in the
     * flow.
     *
    ...
    /**
     * N�mero de unidades de dados representados por esta estrutura. Number of
     * units of data represented for this structure.
     *
     ...
     * implementa��o de serializa��o default de java por ObjectOutputStream por
     * causa do overhead gerado no tamanho do arquivo. Realiza a grava��o das
     * propriedades da unidade de dados.
     *
     ...
     * because of overhead generated in the size of the archive. It carries
     * through the writing of the properties of the unit of data.
     *
    ...
    /**
     * Define como uma inst�ncia deve ser deserializada. Realiza a leitura das
     * propriedades desta unidade de dados.
     *
    ...
    /**
     * Obtem o valor da propriedade que possui este nome. It gets the value of
     * the property that possesss this name.
     *
