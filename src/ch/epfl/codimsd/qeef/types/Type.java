 ...
 * m�quina de execu��o.
 *
 * Abstract classroom that defines the interface of a type of data supported for
...
public interface Type extends Comparable, Cloneable, Serializable {
    ...
    /**
     * Atribui um valor a uma inst�ncia do tipo de dado a partir de sua
    ...
    /**
     * Atribui um valor a uma inst�ncia do tipo de dado a partir de um tipo da
     * linguagem java.
     */
    ...
    /**
     * Obtem a largura ocupada (em n�mero de caracteres) na exibi��o do conte�do
     * de um tipo.
     */
    ...
    /**
     *
     * Fornece express�o regular capaz de reconhecer este tipo em textos. Define
     * sua formata��o. Tipicamente usado no parser de predicados. Ver
     * PredicateParser.
     *
    ...
    /**
     * O framework QEEF define um mecanismo pr�prio de serializa��o dos dados
     * que � implementado pela interface InstanceReader e InstanceWrite.
     * Optou-se por n�o utilizar o mecanismo proposto pela linguagem java via
     * interface Serializable e ObjectOutputStream/ObjectInputStream uma vez que
     * um overhead muito grande � inserido. A implementa��o deste m�todo
     * definir� como uma inst�ncia de Type dever� ser serializada.
     *
     ...
     * interface Serializable e ObjectOutputStream/ObjectInputStream uma vez que
     * um overhead muito grande � inserido. A implementa��o deste m�todo
     * definir� como uma inst�ncia de Type dever� ser deserializada. * @see
