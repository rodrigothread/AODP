...
class ConsumerThread extends Thread {
     ...
     * Invoca m�todo da AsyncControlOperator#consume(Operator, Buffer), e
     * registra o final de processamento inserindo uma tupla null no buffer.
     * Eventualmente registra alguma exce��o ocorrida.
     */
    public void run() {
