...
/**
 * Classe abstrata que generaliza as fun��es de uma estrutura de recupera��o
 * simples. Por exmplo uma fila, pilha e um buffer.
 *
...
public abstract class List extends Estrutura {
    ...
    /**
     * Remove um elemento da estrutura. Cabe a cada implementa��o definir qual a
     * inst�ncia a ser retirada.
     *
     ...
     *
     * @return True se conseguiu remover a inst�ncia da lista, else caso
     * contr�rio.
     */
