...
/**
 * Classe abstrata que generaliza todas as estruturas. Em todas as estruturas,
 * capacity representa o nn�mero m�ximo de elementos que estar�o em mem�ria
 * simultaneamente, e size o tamanho atual da estrutura. Cabe a cada estrutura
 * definir o que fazer quando o n�mero de elementos na estrutura ultrapassar
 * capacity.
 *
...
public abstract class Estrutura {
     ...
     *
     * @param capacity N�mero m�ximo de elementos que podem estar em mem�ria ao
     * mesmo tempo.
     */
