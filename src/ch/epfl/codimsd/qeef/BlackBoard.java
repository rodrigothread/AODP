...
/**
 * The BlackBoard is a CoDIMS structure that stores some objects referenced by a
 * key. It is sent to remote nodes, when the request needs parallelization.
 * Access to the BlackBoard are similar to those for a java HashMap.
 *
