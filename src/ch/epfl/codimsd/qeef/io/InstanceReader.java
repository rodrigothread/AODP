...
/**
 * Fornece a interface de um fluxo capaz de deserializar inst�ncias e blocos de
...
public interface InstanceReader {
     ...
     *
     * @throws IOException Se algum problema ocorrer durante a leitura dos dados
     * da inst�ncia.
     * @throws EOFException Se o fim do fluxo foi atingido antes que os dados de
     * uma inst�ncias tenham sido lidos.
     */
     ...
     * @throws IOException Se algum problema ocorrer durante a leitura dos dados
     * da inst�ncia.
     * @throws EOFException Se o fim do fluxo foi atingido antes que todas as
     * inst�ncias do bloco tenham sido lidas.
     */
     ...
     *
     * @return True se existirem mais inst�ncias a serem lidas do fluxo, false
     * caso contr�rio.
     *
     * @throws IOException Se Ocorrer algum problema ao verifirar se o fluxo
     * possui mais inst�ncias a serem lidas.
     */
