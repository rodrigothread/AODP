...
/**
 * Mant�m as configura��es necess�rias para o funcionamento de uma inst�ncia do
 * framework QEEF.<p>
 * Como: Local de instala��o e Tipo de dados suportados.
 *
 * They keep the necessary configurations for the functioning of an instance of
 * framework QEEF. As: Place of installation and Type of supported data.
 *
 * <p>
 * Todas as informa��es dispon�veis nesta classe podem ser obtidas de maneira
 * est�tica para simplificar seu uso. All the available information in this
 * classroom can be gotten in static way to simplify its use.
 * <p>
 * Trabalho Futuros:
 * <ol>
 * <li>Colocar defini��o das propriedades em arquivo de inicializa��o. To place
 * definition of the properties in inicializa��o archive.
 * </ol>
 *
...
public class Config {
    ...
    /**
     * Tipo de dados suportados indexados pelo nome. Type of supported data
     * indexados for the name.
     */
    private static Hashtable<String, Object> dataTypes;

    /**
     * Tabela de propriedade que mantem algumas informa��es sobre a m�quina de
     * execu��o. Table of property that keeps some information on the execution
     * machine.
     */
    ...
    /**
     * Carrega algumas propriedades utilizadas pela m�quina de execu��o. It
     * loads some properties used for the execution machine.
     */
    ...
    /**
     *
     * Armazena uma propriedade a ser utilzada pela inst�ncia QEEF. It stores a
     * property to be utilzada by instance QEEF.
     *
     ...
     * @return Refer�ncia a um tipo. Null se n�o existir tipo com o nome
     * informado.
     *
