...
/**
 * QEEF defines the functionalities of an execution machine in CoDIMS. The class
 * executes a request in both remote and centralized mode. When executing a
 * request, QEEF methods performs the following :
 * <li> Open the operators;
 * <li> Call getNext on the operator chain, and get the results;
 * <li> Close the operatos.
 *
 * In distributed mode, the request result is converted to a DataHandler object
 * in order to send it in a SOAP message.
 *
 * Othman Tajmouati changes : - Javadoc transalated to english. - Added
 * variables : Metadata[] clientMetada, RequestResult requestResult, ResultSet
 * rset. - Added methods : getRequestResult(), setPlanOperator(), init,
 * getClientMetadata
 *
...
public class QEEF {
    ...
    /**
     * Metadata used for writing the object returns to the client, when QEEF is
     * running in a Local Web Service.
     */
...
//        pa.log("FinishingTime : ", System.currentTimeMillis()-finishingTime);
     ...
     * Close an operator
     *
     * @param op Operador que se deseja encerrar.
     */
     ...
     *
     * @param out Fluxo onde cabe�alho ser� impresso.
     * @param op Operador do qual se obter� metadados.
     */
