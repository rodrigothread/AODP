...
/**
 * QpCompFactory performs a set of operations according to the request type. For
 * instance, when CoDIMS executes a Discovery request, the class loads the
 * DiscoveryPlanManager, and writes useful parameters into the BlackBoard.
 *
 * Version 1
 *
...
public class QPCompFactory {
    ...
    /**
     * Default constructor. It performs a set of actions depending on the
     * request type.
     *
