...
/**
 * Unidade de dados que ecapsula um conjunto de inst�ncias. Unit of data that
 * ecapsula a set of instances.
 *
...
public class Block extends DataUnit implements Cloneable, Serializable {
     ...
     *
     * @param instance Instancia a ser adicionada ao bloco.
     */
     ...
     *
     * @throws IOException Se algum problema ocorrer durante a impress�o.
     */
