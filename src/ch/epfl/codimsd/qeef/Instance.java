...
/**
 * Classe abstrata que define o conceito de inst�ncia no ch.epfl.codimsd.qeef.
 * Uma inst�ncia � uma unidade de dados unit�ria a ser processada que �
 * espec�fica para um modelo de dados. No modelo relacional, por exemplo, uma
 * inst�ncia � representada por uma tupla.
 *
 * Abstract classroom that defines the concept of instance in the
 * ch.epfl.codimsd.qeef. An instance is a unit of data to be processed that she
 * is specific for a model of data. In the relationary model, for example, an
 * instance is represented by a tuple.
 *
...
public abstract class Instance extends DataUnit implements Cloneable {
    ...
    /**
     * Atribui um valor para o primeiro dado nesta inst�ncia que ainda n�o
     * possui um valor.
     *
     ...
     *
     * @param leftInstance Inst�ncia cujos valores ser�o os primeiros na
     * inst�ncia resultante da jun��o.
     * @param rightInstance Inst�ncia cujos valores ser�o os �ltimos na
     * inst�ncia resultante da jun��o.
