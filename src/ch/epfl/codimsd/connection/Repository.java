...
public class Repository {
    ...
    static String cond2(String cond1) {
        ...
        } else if ((cond1_lastSuperieurIndex > cond1_lastEqualIndex) & (cond1_lastSuperieurIndex > cond1_lastInferieurIndex)) {
        ...
        } else if ((cond1_lastInferieurIndex > cond1_lastEqualIndex) & (cond1_lastInferieurIndex > cond1_lastSuperieurIndex)) {
