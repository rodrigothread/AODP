...
/**
 * The ConnectionPoolManager manages a set of Connection pools, where each
 * connection pool corresponds to a set of connections to the same database.
 *
...
public class ConnectionPoolManager {
    ...
    /**
     * Returns an sql connection if it's available, or create a new one
     * otherwise.
     *
    ...
    /**
     * Creates the singleton reference of the ConnectionPoolManager or retunrs
     * the reference id the singleton is already created.
     *
