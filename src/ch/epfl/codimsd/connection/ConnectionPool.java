...
/**
 * The ConnectionPool class defines a connection pool to a specific database
 * IRI. In codims, a connection pool is a set of connections to grouped in a
 * Java Collection. When a user requests a connection, the first free connection
 * is returned; if there are no free connections a new one is created and
 * finally if the maximim amount of connections is already created no
...
public class ConnectionPool {
    ...
    /**
     * The maximum number of sql connections to the same database. This
     * paramater is taken form the Catalog.
     */
    ...
    /**
     * This paramtere indicates if we have reached the maximum number of
     * connections.
     */
    ...
    /**
     * This method creates the connection parameters, ie maximum number of
     * connections, username, password, drivername. All the parameters are taken
     * from the Catalog.
     *
     * @param IRI - The IRI of the database.
     * @throws CatalogException
    ...
    /**
     * This method notifies that a connection has been released, and that it
     * should be added to the vector of free connections.
     *
    ...
    /**
     * This method creates a connection to a database and assign a timeout to
     * it.
     *
