...
/**
 * The ResultSet class defines the result of a CoDIMS query. It is encapsulated
 * in the RequestResult object and implements the Iterator class. The results
 * are represented by a java LinkedList containing
 ...
 * <li> Use the @see ch.epfl.codimsd.query.ResultSet.add() method to write to
 * the list
 * <li> Close the ResultSet
 *
...
public class ResultSet implements Iterator, Serializable {
    ...
    /**
     * Default constructor. It creates a new java LinkedList containing the data
     * units.
     */
    public ResultSet() {
    ...
    /**
     * @return true if there exists another element in the list, false
     * otherwise.
     */
