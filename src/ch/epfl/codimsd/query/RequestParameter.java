...
public class RequestParameter {
    ...
    /**
     * Default constructor. It creates the HashMap that will contain the request
     * parameters.
     */
    ...
    /**
     * Put a parameter into the HashMap. If the HashMap already contains a
     * parameter with the same key the parameter object is overwritten.
     *
     * @param key the String key associated with the parameter
    ...
    /**
     * Returns the number of parameters associated to the query (size of
     * HashMap)
     *
