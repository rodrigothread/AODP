...
/**
 * This class defines the result of a codims request. The main results are
 * encapsulated in the ResultSet object.
 *
...
public class RequestResult implements Serializable {
    ...
    /**
     * Metadata (definition) of the result. It specifies for example the types
     * of results, so the user knows how to read them.
     */
    ...
    /**
     * First constructor. You should use the setXXX methods to fill the
     * ResultSet object.
     */
