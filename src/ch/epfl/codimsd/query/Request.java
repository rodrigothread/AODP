 ...
 * @date April 13, 2006
 *
 * This class defines a request within Codims. Each request should contain a
 * query that implements the interface {@link ch.epfl.codimsd.query.Query}.
 *
 */
public class Request {

    /**
     * The requestType. See codims constants for a complete list of request type
     * values.
     */
    ...
    /**
     * Builds the codims request with a requestID. This constructor is used if
     * codims runs in multi user mode.
     *
     * @param query a supported query in codims.
     * @param requestType the requestType associated to this request, you should
     * verify that the requestType is defined in codims constants, as well as in
     * the catalg.
